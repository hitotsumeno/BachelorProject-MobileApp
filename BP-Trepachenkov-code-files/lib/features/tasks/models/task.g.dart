...
const TaskSchema = CollectionSchema(
  ...
  properties: {
    r'diffculty': PropertySchema(
      id: 0,
      name: r'diffculty',
      type: IsarType.byte,
      enumMap: _TaskdiffcultyEnumValueMap,
    ),
...
void _taskSerialize(
  ...
  writer.writeByte(offsets[0], object.diffculty.index);
...
Task _taskDeserialize(
  ...
  final object = Task();
  object.diffculty =
      _TaskdiffcultyValueEnumMap[reader.readByteOrNull(offsets[0])] ??
          TaskDifficulty.easy;
...
P _taskDeserializeProp<P>(
  ...
  switch (propertyId) {
    case 0:
      return (_TaskdiffcultyValueEnumMap[reader.readByteOrNull(offset)] ??
...
const _TaskdiffcultyEnumValueMap = {
  'easy': 0,
  'medium': 1,
  'hard': 2,
};
const _TaskdiffcultyValueEnumMap = {
...
extension TaskQueryFilter on QueryBuilder<Task, Task, QFilterCondition> {
  QueryBuilder<Task, Task, QAfterFilterCondition> diffcultyEqualTo(
      TaskDifficulty value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'diffculty',
        value: value,
      ));
    });
  }

  QueryBuilder<Task, Task, QAfterFilterCondition> diffcultyGreaterThan(
    TaskDifficulty value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> diffcultyLessThan(
    TaskDifficulty value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> diffcultyBetween(
...
extension TaskQuerySortBy on QueryBuilder<Task, Task, QSortBy> {
  QueryBuilder<Task, Task, QAfterSortBy> sortByDiffculty() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'diffculty', Sort.asc);
    });
  }

  QueryBuilder<Task, Task, QAfterSortBy> sortByDiffcultyDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'diffculty', Sort.desc);
    });
  }
...
extension TaskQuerySortThenBy on QueryBuilder<Task, Task, QSortThenBy> {
  QueryBuilder<Task, Task, QAfterSortBy> thenByDiffculty() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'diffculty', Sort.asc);
    });
  }

  QueryBuilder<Task, Task, QAfterSortBy> thenByDiffcultyDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'diffculty', Sort.desc);
    });
  }
...
extension TaskQueryWhereDistinct on QueryBuilder<Task, Task, QDistinct> {
  QueryBuilder<Task, Task, QDistinct> distinctByDiffculty() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'diffculty');
    });
  }
...
extension TaskQueryProperty on QueryBuilder<Task, Task, QQueryProperty> {
  ...
  QueryBuilder<Task, TaskDifficulty, QQueryOperations> diffcultyProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'diffculty');
    });
  }
